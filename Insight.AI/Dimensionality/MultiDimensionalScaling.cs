...
{
    public class MultiDimensionalScaling : IFeatureExtraction
    {
        /// <summary>
        /// Default constructor.
        /// </summary>
        ...
        /// <summary>
        /// Extracts the most important features from a data set using MDS.
        /// </summary>
        ...
        {
            return PerformMDS(matrix, null, null);
        }
        ...
        {
            return PerformMDS(matrix, featureLimit, null);
        }
        ...
        {
            return PerformMDS(matrix, null, percentThreshold);
        }

        private InsightMatrix PerformMDS(InsightMatrix matrix, int? featureLimit, double? percentThreshold)
        {
            // TODO
